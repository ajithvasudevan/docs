...
<br><br>
## Features
* The _Tasmota_ support for this module enables the display of numbers (both integers and floats) and basic text. For example, sending the text "22.5^" displays "22.5°"
